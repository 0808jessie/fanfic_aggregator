...
import { removeBlacklistGroup, updateBlacklistGroup, upsertBlacklistGroup, type BlacklistGroup } from "@/lib/personalLibrary";
...
type BlacklistGroupManagerProps = {
  ...
  onShowFilteredResultsChange: (value: boolean) => void;
};

export function BlacklistGroupManager({ groups, showFilteredResults, onGroupsChange, onShowFilteredResultsChange }: BlacklistGroupManagerProps) {
