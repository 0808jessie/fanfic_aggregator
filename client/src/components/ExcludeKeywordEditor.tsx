...
import { FolderPlus, ShieldOff, Trash2, X } from "lucide-react";
...
export function BlacklistGroupManager({ groups, onGroupsChange }: BlacklistGroupManagerProps) {
