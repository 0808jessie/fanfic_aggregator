...
import { Eye, EyeOff, ShieldAlert, Sparkles, Trash2 } from "lucide-react";
...
export function ReadingPreferencesDialog({ open, onOpenChange, settings, cacheStats, onConfirmAge, onClearCache }: ReadingPreferencesDialogProps) {
